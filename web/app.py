...
# Função para encontrar a porta serial automaticamente para o Raspberry Pi Pico
def find_pico_port():
    ports = list(serial.tools.list_ports.comports())
    for p in ports:
        # Ajusta o filtro para o Raspberry Pi Pico
        if 'PicoW' in p.description or 'RP2040' in p.description:
            return p.device
...
def read_serial(stop_event=None):
    ...
    port = find_pico_port() or 'COM4'  # Usa COM4 como fallback
