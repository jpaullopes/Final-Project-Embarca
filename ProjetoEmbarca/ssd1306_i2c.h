// Remove or conditionally define count_of to avoid redefinition.
// For example, you can remove the next line since Pico SDK already defines count_of.
...
#define ssd1306_i2c_clock 9999 // Define o tempo do clock (pode ser aumentado)
